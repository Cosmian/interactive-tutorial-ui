  ...
  const handleIndexDatabase = async (): Promise<void> => {
    try {
      ...
      const runTest = async () => {
        ...
        const authenticatedDataSize = 20;
    ...
    <Split>
      <Split.Content>
        ...
        <p>
          ...
          <a href="https://github.com/Cosmian/cloudproof_js">cloudproof_js library</a>. The library provides a Typescript-friendly API for
          using the <a href="https://github.com/Cosmian/cloudproof_rust">Cosmian's Cloudproof Encryption</a> product written in Rust. You
          are free to use any other encryption solution according to your needs.
        </p>
